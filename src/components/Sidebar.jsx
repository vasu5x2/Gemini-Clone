...
const Sidebar = () => {
  ...
  return (
    <div className="min-h-screen inline-flex flex-col justify-between bg-[#e4e7eb] py-[15px] px-[25px]">
      <div>
        <IoMenu
        ...
        <div
          onClick={() => newChat()}
          className="mt-[40px] inline-flex items-center gap-[15px] py-[10px] px-[15px] text-[14px] text-gray-500 cursor-pointer bg-gray-300 rounded-full"
        >
